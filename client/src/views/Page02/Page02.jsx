    ...
    <div className="textContainer">
      <p>
        <input
          ...
          id="characterOne"
          value={charTwo}
          onChange={onChangeCharTwo}
          placeholder="Name (character two)"
        ></input>{" "}
        said, "{data.characterOne}, you are looking quite green."
      </p>
      <p>
        "But I always look green", said {data.characterOne}. "I am a{" "}
        <input
          type="text"
          id="animalOne"
          value={animOne}
          onChange={onChangeAnimOne}
          placeholder="green animal"
        ></input>
        ."
      </p>
      <Link to="/page-03">
