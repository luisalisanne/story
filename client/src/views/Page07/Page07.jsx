...
export default function Page07() {
    ...
    return (
        <div className="textContainer">
            ...
            <p>Then {data.characterTwo} began to bang their head against the <input type="text" id="objectTwo" value={objTwo} onChange={onChangeObjTwo} placeholder="object"></input>.</p>

            <Link to="/page-08"><button onClick={onClickHandler}>Next</button></Link>
