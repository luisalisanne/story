...
export default function Page05() {
    ...
    return (
        ...
        <p>{data.characterTwo} walked up and down on the porch for a long time.</p>
        <p>But they could not think of a story to tell {data.characterOne}.</p>
        <p>Then {data.characterTwo} went into the house and stood on their <input type="text" id="objectOne" value={objOne} onChange={onChangeObjOne} placeholder="..."></input>.</p>

        <Link to="/page-06"><button onClick={onClickHandler}>Next</button></Link>
